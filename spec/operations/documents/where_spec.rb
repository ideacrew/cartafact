...
RSpec.describe Documents::Where do
  let(:subject) { Documents::Where.new.call(authorization_information) }
  let(:document) { FactoryBot.create(:documents_document_model, subjects: [{ subject_id: 'abc', subject_type: 'consumer' }]) }
