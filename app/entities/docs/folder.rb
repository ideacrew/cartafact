...
class Docs::Folder < Dry::Struct
  ...
  # The {Account} name that created this Folder
  # @return [Account]
  attribute :created_by,  Account.meta(omittable: false)

  # @!attribute [r] namespace
  # This Folder's position in the Folder tree
  # @return [Namespace]
  attribute :namespace, Docs::Namespace.meta(omittable: false)
  ...
  # @return [DateTime]
  attribute :purged_at,  Types::DateTime.meta(omitttable: false)
